...
// //     } catch (error) {
// //         console.error('Error scraping rink data:', error);
// //         return {};
// //     } finally {
// //         await browser.close();
// //     }
...
// // // URL of the rink page
// // const rinkURL = 'https://www.hockeyfinder.com/skate-times/rink/91';

// // // Scrape data for the rink
// // scrapeRinkData(rinkURL)
// //     .then(data => {
// //         console.log('Scraped data:', data);
// //         fs.writeFileSync('rink_data.json', JSON.stringify(data, null, 2));
// //         console.log('Data saved to rink_data.json');
// //     })
// //     .catch(error => console.error('Error scraping rink data:', error));
